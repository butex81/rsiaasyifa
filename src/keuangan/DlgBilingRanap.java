...
public class DlgBilingRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-01-2018 16:41:13" }));
        ...
        chkBulat.setBounds(500, 380, 90, 23);
        ...
        if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            try{
                ...
                if(ChkPiutang.isSelected()==false){                        
                    ...
                    Sequel.menyimpan("temporary_bayar_ranap","'0','KEMBALIAN',':','','','','','<b>"+TKembali.getText()+"</b>','Tagihan','','','','','','','','',''","Rekap Harian Tindakan Dokter"); 
