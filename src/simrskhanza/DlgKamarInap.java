...
public class DlgKamarInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnRujukMasuk.setPreferredSize(new java.awt.Dimension(220, 26));
        ...
        SetStatus.setBackground(new java.awt.Color(248, 253, 243));
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-09-2017" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-09-2017" }));
            ...
            try {
                ...
                try {
                    ...
                    if(rs.next()){
                        ...
                        if(Sequel.menyimpantf2("reg_periksa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Reg Periksa",20,
                            ...
                            rs.getString("almt_pj"),rs.getString("hubunganpj"),rs.getString("biaya_reg"),"Belum","Baru","Ranap",rs.getString("kd_pj"),umur,sttsumur,"","",var.getkode()})==true){
